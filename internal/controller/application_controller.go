...
import (
	...
	"github.com/Marulasiddu/Application-operator/api/v1alpha1"
	applicationv1alpha1 "github.com/Marulasiddu/Application-operator/api/v1alpha1"
)
...
var finalizer = "batch.tutorial.kubebuilder.io/finalizer"
...
func (r *ApplicationReconciler) reconcileCreate(ctx context.Context, app *applicationv1alpha1.Application) (ctrl.Result, error) {
...
func (r *ApplicationReconciler) createOrUpdateDeployment(ctx context.Context, app *applicationv1alpha1.Application) error {
...
func (r *ApplicationReconciler) createService(ctx context.Context, app *applicationv1alpha1.Application) error {
	srv := v1.Service{
		ObjectMeta: metav1.ObjectMeta{
...
func (r *ApplicationReconciler) reconcileDelete(ctx context.Context, app *applicationv1alpha1.Application) (ctrl.Result, error) {
	l := log.FromContext(ctx)
